    ...
    return (
        <div className="jumbotron rounded-lg col-6 py-5 mt-5 bg-white mx-auto text-center">
            ...
            <div className='text-muted mt-4'>
                Created by 
                Steven Parson <a href="https://github.com/sap2411" target="_blank"><i class="fab fa-github" /></a> <a href="https://www.linkedin.com/in/steven-parsons-716654134" target="_blank"><i class="fab fa-linkedin" /></a>
                , 
                Gabriel de Sousa <a href="https://github.com/GabedeSousa" target="_blank"><i class="fab fa-github" /></a> <a href="https://www.linkedin.com/in/gabriel-fidelis-de-sousa-25b102110/" target="_blank"><i class="fab fa-linkedin" /></a>
                , and
                Mathew Wheatley <a href="https://github.com/mathewpwheatley" target="_blank"><i class="fab fa-github" /></a> <a href="https://www.linkedin.com/in/mathewpwheatley" target="_blank"><i class="fab fa-linkedin" /></a>
            </div>
        </div>
    )
}
